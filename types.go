...
// Email recipient details for item sharing.
type ValidRecipientEmailInner struct {
	Email string `json:"email"`
}

// Domain recipient details for item sharing.
...
// ByState filters item lists by active and archived state.
...
// Memorable password recipe parameters.
...
// PIN password recipe parameters.
type PasswordRecipePinInner struct {
	// Number of digits in the PIN.
	Length uint32 `json:"length"`
}

// Random password recipe parameters.
